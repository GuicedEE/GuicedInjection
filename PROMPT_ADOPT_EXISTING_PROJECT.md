...
- Repository URL / local path: https://github.com/GuicedEE/GuicedInjection.git
- Org and project name: GuicedEE / GuicedEE Inject
- Short description: Implementation of the library providing Guice injection and functionality for the GuicedEE ecosystem.
- License (if missing or to change): LICENSE (present)
